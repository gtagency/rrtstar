...
int Publisher::publishEnvironment (region& regionOperating, region& regionGoal, list<region*>& obstacles) {
...
template<class Planner, class System>
int Publisher::publishTraj (Planner& planner, System& system) {
...
template<class Planner, class System>
int Publisher::publishTree (Planner& planner, System& system) {
