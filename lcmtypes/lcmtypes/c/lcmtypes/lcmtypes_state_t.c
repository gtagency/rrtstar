...
static int64_t __lcmtypes_state_t_hash;
...
int64_t __lcmtypes_state_t_hash_recursive(const __lcm_hash_ptr *p)
{
    ...
    const __lcm_hash_ptr cp = { p, (void*)__lcmtypes_state_t_get_hash };
    (void) cp;

    int64_t hash = 0x573f2fdd2f76508fLL
...
int64_t __lcmtypes_state_t_get_hash(void)
{
    if (!__lcmtypes_state_t_hash_computed) {
        __lcmtypes_state_t_hash = __lcmtypes_state_t_hash_recursive(NULL);
