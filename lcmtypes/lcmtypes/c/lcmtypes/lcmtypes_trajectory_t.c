...
static int64_t __lcmtypes_trajectory_t_hash;
...
int64_t __lcmtypes_trajectory_t_hash_recursive(const __lcm_hash_ptr *p)
{
    ...
    const __lcm_hash_ptr cp = { p, (void*)__lcmtypes_trajectory_t_get_hash };
    (void) cp;

    int64_t hash = 0x67039c5ec5ece44fLL
...
int64_t __lcmtypes_trajectory_t_get_hash(void)
{
    if (!__lcmtypes_trajectory_t_hash_computed) {
        __lcmtypes_trajectory_t_hash = __lcmtypes_trajectory_t_hash_recursive(NULL);
