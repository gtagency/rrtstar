...
static int64_t __lcmtypes_environment_t_hash;
...
int64_t __lcmtypes_environment_t_hash_recursive(const __lcm_hash_ptr *p)
{
    ...
    const __lcm_hash_ptr cp = { p, (void*)__lcmtypes_environment_t_get_hash };
    (void) cp;

    int64_t hash = 0x8caabc2a2ba0f9c7LL
...
int64_t __lcmtypes_environment_t_get_hash(void)
{
    if (!__lcmtypes_environment_t_hash_computed) {
        __lcmtypes_environment_t_hash = __lcmtypes_environment_t_hash_recursive(NULL);
