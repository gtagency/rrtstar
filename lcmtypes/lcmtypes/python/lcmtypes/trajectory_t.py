...
class trajectory_t(object):
    ...
    def _encode_one(self, buf):
        ...
        for i0 in range(self.num_states):
            assert self.states[i0]._get_packed_fingerprint() == state_t.state_t._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        self.states = []
        for i0 in range(self.num_states):
            self.states.append(state_t.state_t._decode_one(buf))
        return self
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x67039c5ec5ece44f+ state_t.state_t._get_hash_recursive(newparents)) & 0xffffffffffffffff
